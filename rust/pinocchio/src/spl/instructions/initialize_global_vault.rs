...
impl<'a> InitializeGlobalVault<'a> {
    ...
    pub fn invoke_signed(&self, signers: &[Signer<'_, '_>]) -> ProgramResult {
        ...
        instruction_accounts[4].write(InstructionAccount::readonly(self.token_program.address()));
        instruction_accounts[5].write(InstructionAccount::readonly(
            self.associated_token_program.address(),
        ));
        instruction_accounts[6].write(InstructionAccount::readonly(self.system_program.address()));
        ...
        accounts[4].write(self.token_program);
        accounts[5].write(self.associated_token_program);
        accounts[6].write(self.system_program);
