...
pub const EPHEMERAL_VAULT_ID: Pubkey = Pubkey::new_from_array(EPHEMERAL_VAULT_PUBKEY.to_bytes());
...
pub const HYDRA_PROGRAM_ID: Pubkey =
    Pubkey::from_str_const("Hydra17i1feui9deaxu6d1TzSQMRNHeBRkDR1Awy7zea");
