...
use crate::{
    ...
    spl::{
        ...
        find_vault_ata, EphemeralSplDiscriminator, GlobalVault,
    },
};

pub struct SetupAndDelegateShuttleEphemeralAtaWithMergeBuilder {
...
impl SetupAndDelegateShuttleEphemeralAtaWithMergeBuilder {
    #[inline(always)]
    pub fn instruction(&self) -> compat::Instruction {
        ...
        data.push(EphemeralSplDiscriminator::SetupAndDelegateShuttleEphemeralAtaWithMerge as u8);
